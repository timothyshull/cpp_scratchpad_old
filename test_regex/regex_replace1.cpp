...
int main() {
    ...
    cout << regex_replace(data, reg, "<\\1 value=\"\\2\"/>", regex_constants::format_sed) << "\n";
    // use iterator interface, and
    // - format_no_copy: don’t copy characters that don’t match // - format_first_only: replace only the first match found
    string res2;
